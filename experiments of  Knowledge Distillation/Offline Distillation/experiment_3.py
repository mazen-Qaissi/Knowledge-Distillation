...
train_dataset = torchvision.datasets.CIFAR100(root='./dataCIFAR100', train=True, download=True, transform=train_transform)

test_dataset = torchvision.datasets.CIFAR100(root='./dataCIFAR100', train=False, download=True, transform=test_transform)
...
def train_KD(moudel_Student,train_loader, test_loader, train_dataset, model_teacher, learning_rate, num_epochs):
    Temp_step = [1,2,3,4,5]
    # trying different Temps
    print("the first experiment is trying different T with distillation")
    for t in Temp_step:
        model_1 = moudel_Student
        criterion = nn.CrossEntropyLoss()
...
if __name__ == '__main__':
    ...
    train_KD(model_vgg8,train_loader,test_loader,train_dataset,log_T,0.05,40)
