...
model_T = train_model(model_T,0.001,15,train_loader,test_loader)

model_S = ResNet(ResidualBlock, [2, 2, 2, 2]).to(device)
model_S = train_model(model_S,0.001,15,train_loader,test_loader)

train_KD(train_loader,test_loader,trainset,testset,model_T,0.001,15)
